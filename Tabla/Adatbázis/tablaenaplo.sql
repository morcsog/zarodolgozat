...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2021. Ápr 08. 10:18
...
(5, NULL, 4, 1, 'tesztAdminReg', '7EyINtuWuKyoOBx8ZLsJW6RtXig='),
...
--
ALTER TABLE `jegyek`
  ADD CONSTRAINT `jegyek_ibfk_2` FOREIGN KEY (`TanarID`) REFERENCES `tanitja` (`TanarID`),
  ADD CONSTRAINT `jegyek_ibfk_3` FOREIGN KEY (`DiakID`) REFERENCES `diakok` (`ID`),
  ADD CONSTRAINT `jegyek_ibfk_4` FOREIGN KEY (`TantargyID`) REFERENCES `tanitja` (`TantargyID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
